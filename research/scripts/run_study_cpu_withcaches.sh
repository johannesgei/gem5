...
BINARY="$RESEARCH_DIR/benchmarks/cpu/main"
BENCHMARK_BINARY="$RESEARCH_DIR/benchmarks/cpu/main_benchmark"

# Konfiguration der Parameter-Sweeps
SIZES=(2 4 8 16 32 64 128 256 512 1024 2048 4096) # Gewünschte Vektorlängen
# # SIZES=($((2**20)) $((2048*2048)) $((4096*4096)) $((8192*8192)))
# SIZES=$((2**22))
